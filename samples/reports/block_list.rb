...
begin
  ...
  puts "Retreiving blocks"

  response = client.create_blocklist_report(start_date, end_date, scope, format)
  ...
  puts "Exception thrown.  Error during block report creation: #{e.message}"
end
